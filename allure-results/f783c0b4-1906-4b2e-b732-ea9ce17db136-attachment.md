...
Call log:
  - waiting for locator('textarea[placeholder=""]')
    ...
    at C:\Users\afsar\TestabilityProject\tests\userSettings.test.spec.ts:23:22
```
...
- list:
  ...
  - listitem: "RequestId: S48EP65R1SEE4QQ8"
  - listitem: "HostId: L/2mKQcT+IOVuFUyGsnC7ra6CNak3Rq/t55b6X/DWBcLvJ/s7eFf8206A7SC0saK7uilkv87tQk="
- separator
```
